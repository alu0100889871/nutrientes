...
Gem::Specification.new do |spec|
  ...
  spec.description   = %q{Creacion de una clase Alimento y utilización de la misma con pruebas TDD a través de RSpec(expectativa). Para crear la estructura se hizo uso de Bundler.}
